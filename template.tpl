            ...
            "subParams": [
              {
                ...
                "simpleValueType": true,
                "help": "If enabled, the tag will attempt to automatically map the \u003ci\u003egclid\u003c/i\u003e, \u003ci\u003egbraid\u003c/i\u003e and \u003ci\u003ewbraid\u003c/i\u003e values using the following sources (in order): Event Data \u003e URL Parameter \u003e Server Cookie \u003e JavaScript Cookie.\n\u003cbr/\u003e\u003cbr/\u003e\nAny value you manually enter in a field below will always override the auto-mapped value.\n\u003cbr/\u003e\u003cbr/\u003e\n⚠️ Note that this feature might break if Google changes the format of the cookie values. Stape will do its best to keep up with the changes. \n\u003cbr/\u003e\u003cbr/\u003e\nDefault mappings:\n\u003cul\u003e\n\u003cli\u003egclid: \u003ci\u003egclid\u003c/i\u003e Event Data value \u003e \u003ci\u003egclid\u003c/i\u003e URL Parameter value \u003e \u003ci\u003eFPGCLAW\u003c/i\u003e Server Cookie value \u003e \u003ci\u003e_gcl_aw\u003c/i\u003e JavaScript cookie value\u003c/li\u003e\n\u003cli\u003egbraid: \u003ci\u003egbraid\u003c/i\u003e Event Data value \u003e \u003ci\u003egbraid\u003c/i\u003e URL Parameter value \u003e \u003ci\u003eFPGCLAG\u003c/i\u003e Server Cookie value \u003e \u003ci\u003e_gcl_ag\u003c/i\u003e JavaScript cookie value\u003c/li\u003e\n\u003cli\u003ewbraid: \u003ci\u003ewbraid\u003c/i\u003e Event Data value \u003e \u003ci\u003ewbraid\u003c/i\u003e URL Parameter value \u003e \u003ci\u003eFPGCLGB\u003c/i\u003e Server Cookie value \u003e \u003ci\u003e_gcl_gb\u003c/i\u003e JavaScript cookie value\u003c/li\u003e\n\u003c/ul\u003e",
                "defaultValue": false
              },
              {
                "type": "TEXT",
...
function addAdIdentifiers(data, eventData, conversionEvent) {
  ...
  if (isUIFieldTrue(data.autoMapAdIdentifiersSessionAttributes)) {
    const sessionAttributes =
      eventData.session_attributes || getCookieValues('_dm_session_attributes')[0];
...
function getClickIds(eventData) {
  const parseClickIdFromCookie = (cookieName, cookieType) => {
  ...
  return {
    gclid:
      ...
      parseClickIdFromCookie('FPGCLAW', 'server') ||
      parseClickIdFromCookie('_gcl_aw', 'js'),
    gbraid:
      eventData.gbraid ||
      urlSearchParams.gbraid ||
      parseClickIdFromCookie('FPGCLAG', 'server') ||
      parseClickIdFromCookie('_gcl_ag', 'server'), // '_gcl_ag' follows the Server format
    wbraid:
      eventData.wbraid ||
      urlSearchParams.wbraid ||
      parseClickIdFromCookie('FPGCLGB', 'server') ||
      parseClickIdFromCookie('_gcl_gb', 'js')
  };
}
